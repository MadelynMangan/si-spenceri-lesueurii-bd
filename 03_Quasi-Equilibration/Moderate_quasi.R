# File: Moderate_quasi.R
# Title: Quasi-equilibration of a moderate elevation SI model for spenceri/lesueurii
...
#     This script is called by the script Moderate_quasi_set.R, which cycles through a parameter set of
...
densSP <- n4+n5+n6    # extract initial SP density
densLE <- n3+n4+n5+n6 # extract initial LE density
