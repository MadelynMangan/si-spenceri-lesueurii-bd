# File: High_quasi.R
# Title: Quasi-equilibration of a high elevation SI model for spenceri/lesueurii
...
#     This script is called by the script High_quasi_set.R, which cycles through a parameter set of
...
initial <- c(
   ...
   # Subadults, Year 4
   S_S4.1_SP = n4*z.SP, # Susceptible
   I_S4.1_SP = 0,       # Infected 
   # Adults, Year 1
   S_A1.1_SP = n5*z.SP, # Susceptible
   I_A1.1_SP = 0,       # Infected 
   #Adults, Year 2
   S_A2_SP = n6*z.SP, # Susceptible 
   I_A2_SP = 0,       # Infected 
   ...
   # Subadults, Year 3
   S_S3.1_LE = n3*z.LE, # Susceptible
   I_S3.1_LE = 0,       # Infected 
   # Adults, Year 1
   S_A1.1_LE = n4*z.LE, # Susceptible
   I_A1.1_LE = 0,       # Infected 
   # Adults, Year 2
   S_A2_LE = (n5+n6)*z.LE, # Susceptible 
   I_A2_LE = 0,            # Infected 
   ## Zoospore Pool
...
parameters = c(
   ...
   gamma.S4_SP = set$gamma.S4_SP, # Subadults, Year 4
   ...
   beta.S2_LE = set$beta.S2_LE*beta_mod,  # Subadults, Year 2
   beta.S3_LE = set$beta.S3_LE*beta_mod,  # Subadults, Year 3
...
densSP <- n5+n6    # extract initial SP density
densLE <- n4+n5+n6 # extract initial LE density
