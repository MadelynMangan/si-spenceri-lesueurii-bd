...
parameters = c(
   ...
   m.S1_SP = log(1-.463)/(-365),     # Subadults, Year 1
   m.S2_SP = log(1-.445)/(-365),     # Subadults, Year 2
   m.A1_SP = log(1-.358)/(-365),     # Adults, Year 1
   m.A2_SP = log(1-.358)/(-365),     # Adults, Year 2
   # Rate of ageing
   ...
   mu.L_SP = 0,                      # Larvae
   mu.J_SP = log(1-.184)/(-365),     # Juveniles
   mu.S1_SP = log(1-.184)/(-365),    # Subadults, Year 1
   mu.S2_SP = log(1-.191)/(-365),    # Subadults, Year 2
   mu.A1_SP = log(1-.221)/(-365),    # Adults, Year 1
   mu.A2_SP = log(1-.221)/(-365),    # Adults, Year 2
   ...
   m.S1_LE = log(1-.296)/(-365),     # Subadults, Year 1
   m.A1_LE = log(1-.157)/(-365),     # Adults, Year 1
   m.A2_LE = log(1-.157)/(-365),     # Adults, Year 2
   # Rate of ageing
   ...
   # Added mortality rate due to infection
   mu.L_LE = 0,                      # Larvae
   mu.J_LE = log(1-.578)/(-365),     # Juveniles 
   mu.S1_LE = log(1-.578)/(-365),    # Subadults, Year 1
   mu.A1_LE = log(1-.692)/(-365),    # Adults, Year 1
   mu.A2_LE = log(1-.692)/(-365),    # Adults, Year 2
   # recovery rate from infection
   gamma.L_LE = 0,                   # Larvae
...
findRootSP(0, 5, 1.231760, 0.00001)
# L. spenceri bisection exploring instantaneous daily growth rates from 0 to 5
findRootLE(0, 5, 4.524205, 0.00001)
