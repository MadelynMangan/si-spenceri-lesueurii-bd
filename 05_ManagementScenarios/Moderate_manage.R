# File: Moderate_manage.R
# Title: Moderate-elevation SI model in Litoria spenceri/lesueurii system
# Author: M.J. Mangan
...
#     transmission.
#     
#     This script is called by Moderate_*_set.R where * corresponds to the management scenario being 
