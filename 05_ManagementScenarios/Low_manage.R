# File: Low_manage.R
# Title: Low elevation SI model in Litoria spenceri/lesueurii system
...
#     transmission.
#     
#     This script is called by Low_*_set.R where * corresponds to the management scenario being 
