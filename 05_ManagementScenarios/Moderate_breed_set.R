# File: Moderate_breed_set
# Description: runs Moderate-elevation simulations across levels of fecundity
...
save(All_Results_All, parm_draw, init_draw, f_slide, file = 'Moderate_breed.RData') 
