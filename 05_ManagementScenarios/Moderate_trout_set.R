# File: Moderate_trout_set
# Description: runs Moderate-elevation simulations across levels of trout predation
...
save(All_Results_All, parm_draw, init_draw, m_slide, file = 'Moderate_trout.RData') 