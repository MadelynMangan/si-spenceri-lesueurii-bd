# File: Moderate_exclude_set.R
# Description: runs Moderate-elevation simulations across levels of L. lesueurii removal or exclusion
...
for (i in 1:nPoints){
  ...
  for (j in 1:nSims){
    ...
    source(file = 'Moderate_manage.R') # call script to run 20-year simulation
...
save(All_Results_All, parm_draw, init_draw, mS1_slide, file = 'Moderate_exclude.RData') 