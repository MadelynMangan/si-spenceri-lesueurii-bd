# File: Low_exclude_set.R
# Description: runs Low-elevation simulations across levels of L. lesueurii removal or exclusion
...
save(All_Results_All, parm_draw, init_draw, mS1_slide, file = 'Low_exclude.RData') 